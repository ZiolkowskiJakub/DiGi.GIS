...
namespace DiGi.GIS
{
    public static partial class Query
    {
        ...
        public static async Task<Dictionary<int, byte[]>> BytesDictionary(this Building2D building2D, IEnumerable<int> years, double offset = 5, double width = 300)
        {
        ...
        public static async Task<Dictionary<int, byte[]>> BytesDictionary(this Building2D building2D, Range<int> years, double offset = 5, double width = 300)
        {
            ...
            return await BytesDictionary(building2D, years_Temp, offset, width);
        }

        //public static async Task<Dictionary<int, byte[]>> BytesDictionary(this BoundingBox2D boundingBox2D, IEnumerable<int> years, double width = 300)
        //{
        //    if (years == null)
        //    {
        //        return null;
